...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validators = {
            ...
            phone: (value) => {
                if (value.trim() && !validatePhone(value)) return 'Please enter a valid phone number';
                return null;
            },
            name: (value) => {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ccd7e0a5-c839-45ba-b369-64a42281178d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ccd7e0a5-c839-45ba-b369-64a42281178d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ccd7e0a5-c839-45ba-b369-64a42281178d';
